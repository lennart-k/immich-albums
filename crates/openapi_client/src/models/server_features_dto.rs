...
impl ServerFeaturesDto {
    pub fn new(config_file: bool, email: bool, facial_recognition: bool, map: bool, oauth: bool, oauth_auto_launch: bool, password_login: bool, reverse_geocoding: bool, search: bool, sidecar: bool, smart_search: bool, trash: bool) -> ServerFeaturesDto {
        ServerFeaturesDto {
            config_file,
            email,
            facial_recognition,
